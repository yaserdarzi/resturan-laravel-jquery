...
if (isset($fields)){
  ...
  foreach($fields as $field){
    ...
    <tr >
      ...
      <td ><a href="javascript:void(0);" title="ویرایش" onclick="editIncome('{{$field->id}}')"><i class="fa fa-pencil"></i></a><a  href="javascript:void(0);" class="jtrashicon" title="حذف" onclick="deleteincome('{{$field->id}}}')"><i class="fa fa-trash"></i></a></td>
    </tr>
    <?php
    $i++;
    $j++;
