  ...
  @if (isset($fields))
    ...
    @foreach($fields as $field)
      <tr >
        ...
        <td>{{$field->title}}</td>
        <td>{{$field->desc}}</td>
        <td><a href="javascript:void(0);" class="jtrashicon" title="حذف" onclick="deleteUnit('{{$field->id}}}')"><i class="fa fa-trash"></i></a><a href="javascript:void(0);" title="ویرایش" onclick="editUnit('{{$field->id}}}')"><i class="fa fa-pencil"></i></a></td>
      </tr>
      <?php
      $i++;?>
    @endforeach
