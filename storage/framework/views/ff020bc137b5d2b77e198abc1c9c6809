    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class=" portlet light jform">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                <?php echo renderFilters(url().'/admin/filterTransactionsReport','reportResult',true,true,'datepicker0','datepicker1');?>
            </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-9 col-xs-12">
                <select class="multy" id="types" multiple>
                    <?php
                    if (isset($types)){
...
<script>
    ...
    function getAllReports(){
        ...
        $.ajax('<?php echo url()?>/admin/reportingTransactions',{
            dataType:'json',
            data:{
                fromDate:dateFrom,
                toDate:dateTo,
