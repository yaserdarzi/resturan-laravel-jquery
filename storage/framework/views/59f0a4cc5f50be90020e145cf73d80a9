    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class=" portlet light jform">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                <?php echo renderFilters(url().'/admin/filterFoodsReport','reportResult',true,true,'datepicker0','datepicker1');?>
            </div>
...
<script>
    ...
    function getAllReports(){
        ...
        var order = $('#orderTypes').val();
        //var countFrom = $('#fromCount').val();
        //var countTo = $('#toCount').val();
        $.ajax('<?php echo url()?>/admin/reportingFoods',{
            dataType:'json',
            data:{
                fromDate:dateFrom,
                toDate:dateTo,
