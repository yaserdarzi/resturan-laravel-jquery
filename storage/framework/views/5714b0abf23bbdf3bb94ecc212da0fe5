    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class=" portlet light jform">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                <?php echo renderFilters(url().'/admin/filterPaymentTypeReports','reportResult',true,true,'datepicker0','datepicker1');?>
            </div>
            ...
            <div class="col-lg-2 col-md-3 col-sm-6 col-xs-12">
                <input class="zinput" data-filter="facId" id="facId" placeholder="روش پرداخت">
            </div>
...
<script>
    ...
    function getAllReports(){
        ...
        //var countFrom = $('#fromCount').val();
        //var countTo = $('#toCount').val();
        $.ajax('<?php echo url()?>/admin/reportingPaymentType',{
            dataType:'json',
            data:{
                fromDate:dateFrom,
                toDate:dateTo,
