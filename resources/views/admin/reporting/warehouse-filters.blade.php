    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class=" portlet light jform">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                <?php echo renderFilters(url().'/admin/filterWareHouseReports','reportResult',true,true,'datepicker0','datepicker1');?>
            </div>
            ...
            <div class="col-lg-2 col-md-3 col-sm-6 col-xs-12">
                <input class="zinput" data-filter="fromCount" id="fromCount" placeholder="حداقل مقدار">
            </div>

            <div class="col-lg-2 col-md-3 col-sm-6 col-xs-12">
                <input class="zinput" data-filter="toCount" id="toCount" placeholder="حداکثر مقدار">
            </div>

            <div class="col-lg-2 col-md-3 col-sm-6 col-xs-12">
                <input class="zinput" data-filter="fromFee" id="fromFee" placeholder="حداقل هزینه">
            </div>

            <div class="col-lg-2 col-md-3 col-sm-6 col-xs-12">
                <input class="zinput" data-filter="toFee" id="toFee" placeholder="حداکثر هزینه">
            </div>
...
<script>
    ...
    function getAllReports(){
        ...
        $.ajax('<?php echo url()?>/admin/reportingWarehouse',{
            dataType:'json',
            data:{
                fromDate:dateFrom,
                toDate:dateTo,
